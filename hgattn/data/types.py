...
class TokensAndProbs:
	...
	metric_part: Tensor|Array # int[context], a category for each token, to partition metrics
...
register_pytree_node(
	TokensAndProbs, 
	lambda x: (
		(x.key, x.obs_sym, x.obs_prob, x.input_mask, x.target_mask, x.metric_part, x.active), 
		None),
